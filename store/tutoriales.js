...
const state = () => ({
  ...
  adsense: {
    // ToDo: Add in .env file
    left: '9837792964', // [PES-es] /tutoriales/{alias} CONTENT-LEFT
    top: '3707498883', // [PES-es] /tutoriales/{alias} CONTENT-TOP
    bottom: '8576326964' // [PES-es] /tutoriales/{alias} CONTENT-BOTTOM
  },
  list: tutoriales,
  tags
})
